...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=ccemachinepools;awsmachinepools/status,verbs=get;list;watch
...
func (r *CCEManagedClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, options controller.Options) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1beta1.CCEManagedCluster{}).
		Complete(r)
}
